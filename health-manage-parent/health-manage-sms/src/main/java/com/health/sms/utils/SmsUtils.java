...
public class SmsUtils {
     ...
     */
    public SendSmsResponse sendSms(String telephone, String code, String signName, String template) throws ClientException {
        ...
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode(template);  // TODO 改这里
